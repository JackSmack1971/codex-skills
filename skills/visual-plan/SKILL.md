...
- [Create A Structured Agent-Native Plan — Never Inline](#create-a-structured-agent-native-plan-never-inline)
- [Core Workflow](#core-workflow)
- [Self-Review Before Handoff](#self-review-before-handoff)
- [Visual Surface Choice](#visual-surface-choice)
- [Wireframe quality — read `references/wireframe.md`](#wireframe-quality-read-references-wireframemd)
- [Canvas — read `references/canvas.md`](#canvas-read-references-canvasmd)
- [Document quality — read `references/document-quality.md`](#document-quality-read-references-document-qualitymd)
- [Good vs. bad exemplar — read `references/exemplar.md`](#good-vs-bad-exemplar-read-references-exemplarmd)
- [Tool Guidance](#tool-guidance)
- [Local-Files Privacy Mode](#local-files-privacy-mode)
- [Interpreting comment anchors](#interpreting-comment-anchors)
- [Visibility & Sharing](#visibility-sharing)
...
planning. When a Codex, Markdown, or pasted plan already exists,
...
- **Publish standalone plans.** If the user pasted, referenced, or already has a
  Codex / Markdown plan, treat it as source material, but rewrite
...
and start a new Codex session, then choose Authenticate/Reconnect in the current client.
Auth is stored per client
...
`npx -y @agent-native/core@latest reconnect https://plan.agent-native.com --client codex`
and start a new Codex session, then choose Authenticate/Reconnect in the current client.
Authenticate/Reconnect for the plan connector. To refresh every local client config
