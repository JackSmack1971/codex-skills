...
- [Local-Files Privacy Mode Exception](#local-files-privacy-mode-exception)
- [Always Publish As An Agent-Native Plan — Never Inline](#always-publish-as-an-agent-native-plan-never-inline)
- [When To Use](#when-to-use)
- [Recap The Whole Work Unit](#recap-the-whole-work-unit)
- [Keep The Recap Body Lean](#keep-the-recap-body-lean)
- [Recaps Must Be Substantial](#recaps-must-be-substantial)
- [Canonical Shape And Budgets](#canonical-shape-and-budgets)
- [UI Impact Needs Wireframes](#ui-impact-needs-wireframes)
- [Wireframe Quality — read `references/wireframe.md`](#wireframe-quality-read-references-wireframemd)
- [Open And Report The Recap](#open-and-report-the-recap)
- [Diff → Block Mapping](#diff-block-mapping)
- [Block reference — call `get-plan-blocks`, do not memorize tags](#block-reference-call-get-plan-blocks-do-not-memorize-tags)
- [Before / After Is The Headline](#before-after-is-the-headline)
- [Grounding Rule](#grounding-rule)
- [Security](#security)
- [Bidirectional Loop](#bidirectional-loop)
...
Auth is stored per client config/session; `--client all`
