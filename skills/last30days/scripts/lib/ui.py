...
# Check if we're in a real terminal (not captured by a host runner)
...
To fix this:
1. Add AUTH_TOKEN and CT0 to ~/.config/last30days/.env or .last30days.env
