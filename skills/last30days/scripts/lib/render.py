...
def _render_pre_research_warning(report: schema.Report) -> list[str]:
    ...
    return [
        ...
        "",
        "To fix: in a fresh Codex session, enable the configured web-search tool first,",
...
def _render_degraded_run_warning(report: schema.Report) -> list[str]:
    ...
    Runtime-agnostic: this skill ships to Codex and other supported hosts,
    ...
    return [
        ...
        "plan upstream.",
        "",
        "**If you are the reasoning model hosting this skill** (Codex or another host,",
