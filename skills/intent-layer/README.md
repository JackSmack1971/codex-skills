...
Ask Codex to set up the Intent Layer:
...
3. Ask whether to use `AGENTS.md` at root
...
**Only ONE root context file.** Keep `AGENTS.md` at the project root.
...
- `intent_tools.py detect-state` - Check Intent Layer state
- `intent_tools.py analyze` - Find semantic boundaries
- `intent_tools.py estimate` - Measure directory complexity
