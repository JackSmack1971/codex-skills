...
- [Root Node (Monorepo)](#root-node-monorepo)
- [Child Node (Service)](#child-node-service)
- [Compression Example](#compression-example)
  - [Before (~800 tokens)](#before-800-tokens)
  - [After (~250 tokens)](#after-250-tokens)
...
4. **Compression over explanation** - Assume the agent is capable
